    ...
    <div className="fixed inset-x-0 top-0 z-50 px-4 pt-3 lg:px-6 lg:pt-4">
      <header
        className={cn(
          ...
          scrolled
            ? "border-fuchsia-400/18 bg-[#0F1017]/88 shadow-[0_20px_50px_rgba(0,0,0,0.34),0_0_28px_rgba(162,77,224,0.12)] backdrop-blur-xl"
              ...
              return (
                <a
                  ...
                  className={cn(
                    ...
                    active
                      ? "bg-linear-to-r from-[#8A39F8]/18 via-[#54ABFF]/10 to-[#22D3EE]/16 text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_0_0_1px_rgba(255,255,255,0.05),0_0_24px_rgba(162,77,224,0.16)]"
                      : "text-white/62 hover:-translate-y-0.5 hover:bg-linear-to-r hover:from-[#8A39F8]/16 hover:via-[#53AFFF]/10 hover:to-[#FF6B8E]/18 hover:text-white hover:shadow-[0_12px_28px_rgba(82,77,255,0.14),0_0_22px_rgba(34,211,238,0.1)]"
                  )}
                >
                  {item.label}
                </a>
                  ...
                  return (
                    <a
                      ...
                      className={cn(
                        ...
                        active
                          ? "bg-linear-to-r from-[#8A39F8]/18 via-[#53AFFF]/10 to-[#22D3EE]/16 text-white shadow-[0_0_18px_rgba(162,77,224,0.14)]"
