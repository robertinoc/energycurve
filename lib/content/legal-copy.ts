    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "Deletion: write to us and we will act within 30 days. Deleting your account removes it from our database and from our authentication provider, along with your sets, tracks, analyses and versions.",
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "Supresión: escribinos y actuamos dentro de los 30 días. Borrar tu cuenta la elimina de nuestra base y de nuestro proveedor de identidad, junto con tus sets, tracks, análisis y versiones.",
