    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "Rectificación: cambiá tu nombre desde esa misma página, al instante. Para cambiar el email, registrá un pedido desde ahí — también es tu usuario, y los sets compartidos con vos se asocian por dirección, así que son un par de pasos de nuestro lado y no un botón de guardar.",
          "Limitación y oposición: registrá un pedido desde la página de tu cuenta. Queda anotado con su plazo, y vas a ver esa fecha en la página hasta que contestemos.",
          "Supresión: borrá tu cuenta desde la página de tu cuenta. Pasa 30 días después de que lo pidas — no en el momento — y lo podés deshacer desde esa misma página en cualquier momento de esos 30 días. Mientras tanto tu cuenta sigue funcionando, así que todavía podés descargar tus datos. Borrarla la elimina de nuestra base y de nuestro proveedor de identidad, junto con tus sets, temas, análisis y versiones, y cancela cualquier suscripción. No hay reembolso por la parte no usada de un período pago.",
          "Hasta dónde NO llega el borrado, dicho sin vueltas: las filas de nuestro registro de facturación sobreviven sin su contenido, porque su id es lo que evita que un evento de pago repetido se procese dos veces; Stripe conserva su propio registro de la transacción, porque está obligado; y nuestro proveedor de analítica conserva lo que ya recolectó salvo que se lo pidamos aparte. Tus archivos de audio no se ven afectados, porque nunca estuvieron en nuestros servidores.",
          "Como sea que lo pidas, contestamos dentro de 30 días — es el plazo legal y no depende de la vía que uses. Registrarlo desde tu cuenta sólo significa que ninguno de los dos tiene que acordarse.",
